...
def set_discovery(l1: list, l2: list) -> tuple:
    ...
    set_symmetric_difference = s1.symmetric_difference(s2)
    return set_union, set_intersection, set_difference, set_symmetric_difference


# ------------------------------
def power_via_comprehension(numbers: list[int]) -> list[int]:
    """
    :param numbers: list :return:
    """
    new_list = []
